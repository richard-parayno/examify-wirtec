    ...
    private void getQuestionInfo(){
        ...
        mDatabaseCourses.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                qTextView.setText(questionTexts.get(4));
                choice1Btn.setText(choice1Texts.get(4));
                choice2Btn.setText(choice2Texts.get(4));
                choice3Btn.setText(choice3Texts.get(4));
                choice4Btn.setText(choice4Texts.get(4));
                qAnswer = answerTexts.get(4);
